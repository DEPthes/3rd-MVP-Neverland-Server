...
public class DormitoryNotice extends BaseEntity {
    ...
    @Builder
    public DormitoryNotice(String title, String url, LocalDate pubDate, String campus, boolean isImportant, Univ univ, String category) {
        this.title = title;
        this.url = url;
