...
@Entity
@Getter
@Table(name = "Student_Acts_Notice")
public class StudentActsNotice extends BaseEntity {
    ...
    @Builder
    public StudentActsNotice(String title, String url, LocalDate pubDate, Univ univ) {
        this.title = title;
        this.url = url;
